...
var MainButton = function (props) {
    var style = {
        ...
        typo: props.size ? "paragraph_".concat(props.size) : "paragraph_XL",
    ...
    var stringStyle = Object.keys(style).map(function (key) {
        return "".concat(style[key]);
    }).join(" ");
    ...
    return (React.createElement("button", { type: "submit", onClick: handleClick, className: stringStyle }, props.label));
};
...
var FilterPill = function (props) {
    ...
    return (React.createElement("span", { onClick: handleClick, className: stringStyle }, props.label));
};
